/*
a) Implemente em PostgreSQL as interrogações pedidas na alínea 2 (Pode escolher uma
das soluções que apresentou acima, desde que nesta fase consiga fazer uso de todos os
operadores).
*/

/*
(a) Pretende-se obter informação (nome, morada e telefone) dos clientes e dos gestores
(Nota: lembre-se que na BD os clientes poderão ser clientes, mas têm um valor único
no atrdisc).
*/
...
/*
(b) Liste, agora, informação (nome, morada e telefone) sobre os clientes que também
são gestores.
*/
...
/*
(c) Pretende-se saber que pessoas (nome, morada e telefone) não estão associadas a
nenhuma reserva.
*/
...
/*
(e) O conjunto de dispositivos (noserie, latitude e longitude) de bicicletas cujo
...
/*
(g) Apresente os nomes dos clientes que efectuaram reservas de bicicletas cujo estado tem
como valor “em manutencao” no ano passado (Nota: Faça uso dos operadores/funções
de data e tempo).
*/
